...
def test_runner_replays_capture_without_a_transcriber(tmp_path: Path) -> None:
    """Replay mode never constructs or invokes a transcriber."""
    ...
    result = runner.run(manifest, capture=capture)
